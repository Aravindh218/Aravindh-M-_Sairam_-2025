...
There are 3 roads to city 1,4  roads to city 2 and 5 roads to city 3. The total number of roads is 3x 4 x 5 mod 1234567 = 60 .
...
def connectingTowns(n, routes):
    return reduce(lambda x,y : x*y, routes)
...
def connectingTowns(n, routes):
    ...
    for route in routes:
        total_routes *= route
        total_routes %= 1234567  # This is used to avoid overflow
